...
from preferences.views import CreatePreferences, ListPreferences, RemovePreferences, UpdatePreferences, ListAllPreferences, AssignPreferenceToUser, UnnassignPreferenceFromUser, ListUsersPerPreference
